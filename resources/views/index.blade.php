...
<body>
        ...
        <div id="header-right"> 
          <div id="account">
            ...
            <div id="login-content">
              <div id="login-input">
                <div class="form-group">
                    {!! Form::text('username', null, ['id'=>'username-login-input', 'class'=>'form-control', 'placeholder'=>'Username/email']) !!}
                </div>
                <div class="form-group">
                  {!! Form::password('password', ['id'=>'password-login-input', 'class'=>'form-control', 'placeholder'=>'Password']) !!}
                </div>
              </div>
              <div id="login-button">
                {!! Form::submit('Login', ['id'=>'login-btn', 'class'=>'btn btn-default']) !!}
              </div>
            </div> <!-- end login -->
            <!-- sign up -->
            ...
            <div id="signup-content">
              <div id="signup-input">\
                <div class="form-group">
                    {!! Form::text('firstname', null, ['id'=>'firstname-signup-input', 'class'=>'form-control', 'placeholder'=>'firstname']) !!}
                </div>
                <div class="form-group">
                    {!! Form::text('lastname', null, ['id'=>'lastname-signup-input', 'class'=>'form-control', 'placeholder'=>'lastname']) !!}
                </div>
                <div class="form-group">
                    {!! Form::text('username', null, ['id'=>'username-signup-input', 'class'=>'form-control', 'placeholder'=>'Username/email']) !!}
                </div>
                <div class="form-group">
                  {!! Form::password('password', ['id'=>'password-signup-input', 'class'=>'form-control', 'placeholder'=>'Password']) !!}
                </div>
              </div>
              <div id="login-button">
                {!! Form::submit('Sign up', ['id'=>'signup-btn', 'class'=>'btn btn-default']) !!}
              </div>
            </div> <!-- end sign up -->
          </div>
          <div id="form-search">
    ...
    <div id="content" class="row">
      ...
      <div id="right-menu" class="col-lg-9">
        ...
        <div class="col-lg-12">
          <div id="ads-banner">
            <a href="#">{!! Html::image('../img/ads1.jpg') !!}</a>
          </div>
        </div>
      </div> <!-- END RIGHT MENU -->
    </div>
